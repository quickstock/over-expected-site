...
/** Nav items for the active league: the static four, plus any
    platform-layer boards the league ships (their `to` carries the league,
    since layer routes are `/lineups/:lg`). */
